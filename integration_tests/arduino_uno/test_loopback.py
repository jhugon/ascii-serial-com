...
class TestCBLoopback(unittest.TestCase):
    """
        Requires firmware:

        avrdude -p atmega328p -c arduino -P /dev/ttyACM0 -Uflash:w:build/avr5_gcc_debug/arduino_uno_cb_loopback
...
class TestASCLoopback(unittest.TestCase):
    """
        ...
        avrdude -p atmega328p -c arduino -P /dev/ttyACM0 -Uflash:w:build/avr5_gcc_debug/arduino_uno_asc_loopback
